...
test_score_enter_key:
	python tests/test_score_enter_key.py 2>&1

test_unseeded_export:
	python tests/test_unseeded_export.py 2>&1

test_must_play_balance:
	python tests/test_must_play_balance.py 2>&1
